...
<section class="relative w-full left-1/2 transform -translate-x-1/2 h-screen bg-cover bg-center" style="background-image: url('{{ "/assets/img/hero.webp?v=" | append: site.github.build_revision | relative_url }}');">
Test
</section>
