...
<section class="relative w-screen left-1/2 transform -translate-x-1/2 h-dvh bg-cover bg-bottom vignette p-4" style="background-image: url('{{ "/assets/img/hero.webp?v=" | append: site.github.build_revision | relative_url }}');">
